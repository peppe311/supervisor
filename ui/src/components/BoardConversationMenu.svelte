<script lang="ts">
  ...
  let {owner, label, active = true, children}: {
    owner: string;
    label: string;
    active?: boolean;
    children: Snippet;
...
<div class="conversation-menu" data-board-conversation-menu={owner}>
  <button bind:this={button} class="menu-trigger" type="button" aria-haspopup="dialog"
