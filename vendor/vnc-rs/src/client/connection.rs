...
use crate::{codec, DesktopScreen, PixelFormat, Rect, VncEncoding, VncError, VncEvent, X11Event};
...
impl VncInner {
    ...
    fn record_resolution(&mut self, event: &VncEvent) {
                ...
                for _ in 0..rect_num {
                    ...
                    match rect.encoding {
                        ...
                        VncEncoding::ExtendedDesktopSizePseudo => {
                            ...
                            let reason = rect.rect.x;
                            let result = rect.rect.y;
